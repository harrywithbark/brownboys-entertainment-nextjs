      ...
      <div className="container">
        ...
        <div className="gallery-grid">
          ...
          <div className="gallery-item" data-gallery="" data-category="club">
            <img src="/assets/gallery-club-night.png" alt="Club night dancefloor with colorful DJ lighting" loading="lazy" />
            <span className="gallery-label">Club Night · Vancouver</span>
          </div>
          <div className="gallery-item" data-gallery="" data-category="jaggo">
            <img src="/assets/gallery-jaggo.png" alt="Jaggo celebration with dhol and festive lighting" loading="lazy" />
          ...
          <div className="gallery-item" data-gallery="" data-category="wedding">
            <img src="/assets/gallery-engagement.png" alt="Engagement party with golden uplighting and dancing" loading="lazy" />
            <span className="gallery-label">Engagement · Vancouver</span>
          </div>
          <div className="gallery-item" data-gallery="" data-category="club">
            <img src="/assets/gallery-private-celebration.png" alt="Private celebration dancefloor with LED lighting and confetti" loading="lazy" />
